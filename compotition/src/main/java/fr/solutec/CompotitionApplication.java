...
public class CompotitionApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*
		 * Competition comp1 = new Competition(null, "Billard",
		 * d2.parse("2022-01-17 18:30:00"), d2.parse("2022-02-17 18:30:00"),
		 * "Club 108, Croissy-sur-Seine", d2.parse("2022-01-17 17:30:00"),
		 * "championnat",
		 * "Championnat de billard entre l'utilisateur1 et l'utilisateur2 pendant 1 mois"
		 * , false, g1); Competition comp2 = new Competition(null, "Bière-Pong",
		 * d2.parse("2022-01-17 21:30:00"), null, "Crémaillère de Gaël",
		 * d2.parse("2022-01-17 17:30:00"), "tournoi",
		 * "Bière-pong facon tournoi entre 4 utilisateurs", false, g2); Competition
		 * comp3 = new Competition(null, "Fléchette", d2.parse("2022-01-17 21:30:00"),
		 * null, "Gite en normandie", null, "match",
		 * "Match de fléchettes entre utilisateur1 et utilisateur2", false, g1);
		 * Competition comp4 = new Competition(null, "Max de tucs",
		 * d2.parse("2022-01-17 21:30:00"), d2.parse("2022-02-17 18:30:00"), null,
		 * d2.parse("2022-01-17 17:30:00"), "tournoi", "tournoi ouvert", false, null);
		 * 
		 * competitionRepos.save(comp1); competitionRepos.save(comp2);
		 * competitionRepos.save(comp3); competitionRepos.save(comp4);
		 * 
		 * Participe p1 = new Participe(u1, comp1); Participe p2 = new Participe(u2,
		 * comp1);
		 * 
		 * Participe p3 = new Participe(u2, comp2); Participe p4 = new Participe(u3,
		 * comp2); Participe p5 = new Participe(u4, comp2); Participe p6 = new
		 * Participe(u5, comp2);
		 * 
		 * Participe p7 = new Participe(u1, comp3); Participe p8 = new Participe(u2,
		 * comp3);
		 * 
		 * Participe p9 = new Participe(u1, comp4); Participe p10 = new Participe(u3,
		 * comp4); Participe p11 = new Participe(u4, comp4); Participe p12 = new
		 * Participe(u2, comp4); Participe p13 = new Participe(u5, comp4);
		 * 
		 * participeRepos.save(p1); participeRepos.save(p2); participeRepos.save(p3);
		 * participeRepos.save(p4); participeRepos.save(p5); participeRepos.save(p6);
		 * participeRepos.save(p7); participeRepos.save(p8); participeRepos.save(p9);
		 * participeRepos.save(p10); participeRepos.save(p11); participeRepos.save(p12);
		 ...
		 * 
		 * Duel duel13 = new Duel(comp2, u1, u2, n, 7, 8);
		 */
